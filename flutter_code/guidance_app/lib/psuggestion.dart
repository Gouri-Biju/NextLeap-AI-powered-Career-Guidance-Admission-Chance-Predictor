...
void main() {
  runApp(const ParentSuggestionApp());
}

class ParentSuggestionApp extends StatelessWidget {
  const ParentSuggestionApp({super.key});
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const ParentSuggestionPage(title: 'My Suggestions'),
    );
  }
}

class ParentSuggestionPage extends StatefulWidget {
  const ParentSuggestionPage({super.key, required this.title});
  final String title;

  @override
  State<ParentSuggestionPage> createState() => _ParentSuggestionPageState();
}

class _ParentSuggestionPageState extends State<ParentSuggestionPage> {
                    ...
                    IconButton(
                      ...
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => const ParentCollegeApp()),
                        );
                      },
                    ),
                    Text(widget.title,
