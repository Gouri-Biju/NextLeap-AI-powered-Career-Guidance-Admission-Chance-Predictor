...
void main() {
  runApp(const ParentCollegeApp());
}

class ParentCollegeApp extends StatelessWidget {
  const ParentCollegeApp({super.key});
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const ParentCollegePage(title: 'Colleges'),
    );
  }
}

class ParentCollegePage extends StatefulWidget {
  const ParentCollegePage({super.key, required this.title});
  final String title;

  @override
  State<ParentCollegePage> createState() => _ParentCollegePageState();
}

class _ParentCollegePageState extends State<ParentCollegePage> {
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(onPressed: () async {
              ...
              Navigator.push(context, MaterialPageRoute(builder: (context)=>ParentSuggestionApp()));
